      ...
      await Swal.fire({
        ...
        html: `
          <div class="text-left space-y-2">
            ...
            ${postulacion.urlCv ? `<p><strong>CV:</strong> <a href="${postulacion.urlCv}" target="_blank" class="text-blue-600">Ver CV</a></p>` : ''}
          </div>
        `,
        icon: 'info',
                ...
                {postulacionesFiltradas.map((postulacion, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-600">
                      {postulacion.aniosExperiencia || 0} años
                    </td>
                    <td className="px-6 py-4">
                      <span
                        className={`${getEstadoBadgeColor(postulacion.estado)} text-white px-3 py-1 rounded-full text-xs font-semibold`}
                      >
                        {postulacion.estado}
                      </span>
                    </td>
            ...
            <div key={postulacion.id} className="card-modern p-4">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4 pb-4 border-b border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {postulacion.nivelEducacion || 'N/A'}
                  </p>
                </div>
              </div>
